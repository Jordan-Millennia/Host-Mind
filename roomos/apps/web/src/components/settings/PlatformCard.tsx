...
export function PlatformCard({
  ...
  return (
    <div className={`p-7 bg-[color:var(--color-paper)] border border-[color:var(--color-hairline)] rounded-md ${disabled ? "opacity-60" : ""}`}>
      ...
      <p className="text-sm text-[color:var(--color-ink-3)] mb-4">{description}</p>
      {children}
    </div>
  )
}
